...
const Sidebar = () => {
    const [itemActive, setItemActive] = useState("Order");
    ...
    return (
        <nav className={`border-r border-gray-300 bg-white h-screen hidden md:block fixed z-50 ${miniSideBar ? "w-22" : "w-64"}`}>
